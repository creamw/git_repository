...
public class PrintTestT2{
	...
	public void a_printFinishOrder() throws MalformedURLException, InterruptedException {
		try {
			...
			System.out.println(Thread.currentThread().getName()+"___"+StartAppT2.count);
			StartAppT2.count++;
			//选择第一个菜品
	...
	public void c_repayment() throws MalformedURLException, InterruptedException {
		try {
			...
			Runtime.getRuntime().exec("adb -s 192.168.1.130:5555 shell input tap 224 720");
